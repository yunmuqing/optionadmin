...
(function (window, $, undefined) {
    var pluginName = 'datepicker',
        ...
        defaults = {
            ...
            prevHtml: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true"><path d="M17 9H5.414l3.293-3.293a.999.999 0 1 0-1.414-1.414l-5 5a.999.999 0 0 0 0 1.414l5 5a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414L5.414 11H17a1 1 0 1 0 0-2z"></path></svg>',
            nextHtml: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true"><path d="M17.707 9.293l-5-5a.999.999 0 1 0-1.414 1.414L14.586 9H3a1 1 0 1 0 0 2h11.586l-3.293 3.293a.999.999 0 1 0 1.414 1.414l5-5a.999.999 0 0 0 0-1.414z"></path></svg>',
            navTitles: {
                days: 'MM yyyy',
                months: 'yyyy',
                years: 'yyyy1 - yyyy2'
    ...
    datepicker.prototype = {
        ...
        _buildDatepickersContainer: function () {
            containerBuilt = true;
            if (this.opts.parentEl) {
                $datepickersContainer = this.opts.parentEl;
            }else{
        ...
        selectDates: function (date,data2) {
            ...
            if (opts.multipleDates) {
                ...
                if (len == 2) {
                    ...
                    _this.selectedDates.push(date,data2);
                    _this.maxRange = data2;
                    _this.minRange = date;
                } else {
                    _this.selectedDates = [date];
                    _this.minRange = date;
        ...
        selectDate: function (date) {
            ...
            opts.onApply(_this.selectedDates);
            if (opts.autoClose) {
                if (!opts.multipleDates && !opts.range) {
                    _this.hide();
                } else if (opts.range && _this.selectedDates.length == 2) {
