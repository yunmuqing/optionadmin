...
$(document).ready(function() {
    ...
    $('.viewImg').each(function(){
        upload_img_arr.push($(this).data("src"));
    });
    $('.viewvideo').each(function(){
        upload_video_arr.push($(this).attr("src"));
    });
    ...
    $.ajax({
        ...
        success: function (res) {
            $('.specific_products ').find('.content-show').html('');
            if(res.code == 1){
                ...
                if(res.msg){
                    ...
                    console.log(data,id);
                    reviews_product_id = {};
                    reviews_product_id['id'] = id;
                    reviews_product_id['image'] = data['image'];
                    reviews_product_id['title'] = data['title'];
                    contentShow();
                }
            }
        }
