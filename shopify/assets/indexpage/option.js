$(document).ready(function () {
  jQuery.fn.extend({
    ...
    $(document).on('click', '.add_tem span', function () {
      ...
      if(ymq_temoption.hasOwnProperty(temId) && temType == 1){
          alert('已添加');
          return;
      }
      // $.ajax({
      ...
      //     }
      // });
      var json = {"ymq1tem2":{"id":"1tem2","type":"3","label":"爷爷","options":{"1tem2_1":{"id":"1tem2_1","value":"爷爷1","price":"","price_type":"1","one_time":"0","sku":"","default":"0"},"1tem2_2":{"id":"1tem2_2","value":"爷爷2","price":"","price_type":"1","one_time":"0","sku":"","default":"0"},"1tem2_3":{"id":"1tem2_3","value":"爷爷3","price":"","price_type":"1","one_time":"0","sku":"","default":"0"},"1tem2_4":{"id":"1tem2_4","value":"爷爷4","price":"","price_type":"1","one_time":"0","sku":"","default":"0"}},"required":"0","tooltip":"","tooltip_position":"1","help":""},"ymq1tem3":{"id":"1tem3","type":"3","label":"爸爸","options":{"1tem3_1":{"id":"1tem3_1","value":"爸爸1","price":"","price_type":"1","one_time":"0","sku":"","default":"0"},"1tem3_2":{"id":"1tem3_2","value":"爸爸2","price":"","price_type":"1","one_time":"0","sku":"","default":"0"},"1tem3_3":{"id":"1tem3_3","value":"爸爸3","price":"","price_type":"1","one_time":"0","sku":"","default":"0"},"1tem3_4":{"id":"1tem3_4","value":"爸爸4","price":"","price_type":"1","one_time":"0","sku":"","default":"0"}},"required":"0","tooltip":"","tooltip_position":"1","help":""}};
      var conditionJson = {"1tem3":{"type":"1","andor":"||","show":"1","children":"","options":{"1":{"id":"1tem2","type":"1","value":"1tem2_1,1tem2_2"}}},"1tem3_3":{"type":"2","andor":"||","show":"1","children":"","options":{"1":{"id":"1tem2","type":"1","value":"1tem2_3"}}},"1tem3_4":{"type":"2","andor":"||","show":"1","children":"","options":{"1":{"id":"1tem2","type":"1","value":"1tem2_4"}}}};
      
      if (Number(temType) == 1) {
        addTem1(json,conditionJson,temId,$('.tem_select option:selected').text());
      }else{
        addTem2(json,conditionJson);
      }
    ...
    //吧模板数据引用到产品中
    function addTem1(json,conditionJson,temId,temName){
      //创建模板特殊dom
      var temHtml = `
        <div class="option_box list-group-item card ${tembox}" id="${tembox+temId}" data-id="${temId}" data-type="100">
            <div class="option_box_header card-header">
              ...
              <span class="btn btn-secondary tem_yinru" data-id="${temId}">直接引入</span>
      ...
      for(var key in json){
        var item  = json[key];
        createOptionHtml(item['type'],item['id'],item,{appendId:temoptionbox+temId,optionClass:"option_box card"});
      }
    ...
    //把模板直接添加到产品中
    function addTem2(json,conditionJson){
      ...
      for(var key in json){
        ...
        createOptionHtml(item['type'],ymq_index_prefix+ymq_index,item);
  ...
          $(this).prop('checked',true);
    ...
    ///////////////////下面是构建html的所有方法/////////////////////
    //构建下单属性的html
    function createOptionHtml(type,now_index,value = null,more_info = {appendId:"option_sort",optionClass:"option_box list-group-item card"}){
      //设定初始值
      if (value == null) {
