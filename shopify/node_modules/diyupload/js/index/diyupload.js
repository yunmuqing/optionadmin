...
webUploader.on('fileQueued',function(file){createBox($fileInput,file,webUploader,opt);});
...
webUploader.on('error',
    function(code) {
        ...
        switch (code) {
        case 'F_DUPLICATE':
            text = 'review been selected';
            break;
        case 'Q_EXCEED_NUM_LIMIT':
            text = 'review number exceeds limit';
            break;
        case 'F_EXCEED_SIZE':
            text = 'review file size exceeds limit';
            break;
        case 'Q_EXCEED_SIZE_LIMIT':
            text = 'review file total size exceeds limit';
            break;
        case 'Q_TYPE_DENIED':
            text = 'review invalid file type';
            break;
        default:
            text = 'review unknown error';
            break;
    }
    iziToast.error({
        message: text,
...
function setData(arr_text,viewbox,input){
    var arr = [];
